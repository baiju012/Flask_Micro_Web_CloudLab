# We will launch a book very soon for basic Python, Flask, Cloud computing, RedHat openshift, Project creation and deployment on cloud and additional section of IBM product and features.
